...
<html>
	<head>
		...
		<style>
            ...
            .ratingHolder.voted .vote.active:hover {background-position: 0 -1px;}
...
<!---------------Header---------------->
		...
		<div class="l1">
		<h1><ins><img class="img2" width="550" height="400" align="right" 
		src="https://www.colors.life/upload/blogs/af/42/af427da421485c8f66f2ed3db1c7d1da_RSZ_690.jpg">Шашлык на белом вине</ins></h1>
		</br>
		<div class="content">
		...
		<h2>Ингредиенты для маринада на 1 кг мяса:</h2>	
		<big><table border="1" align="center">
			<tr>
			...
			<tr>
				<td>Белое сухое вино </td>
				<td align="center">300мл</td>		
			</tr>
			<tr>
				<td>Репчатый лук</td>
				<td align="center">6-7шт</td>
			</tr>
			<tr>
				<td>Соль</td>
			...
			<tr>
				...
				<td align="center">2,5 ст.л.</td>
			</tr>
			<tr>
				<td>Специи для шашлыка</td>
				<td align="center">30гр</td>
			</tr>
			<tr>
				<td>Чеснок</td>
				<td align="center">0,5 головки</td>
			</tr>
			<tr>
				<td>Лимон</td>
				<td align="center">1 половинка</td>
			</tr>	 
		</table></big>
		<ol> <h3>Рецепт:</h3>
			...
			<li>Нарезать мясо кусочками 5×5 см и слегка отбить.Приправить мясо солью и перем.</li>
			<li>Лук очищаем, нарезаем толстыми кольцами – так его удобнее будет насаживать на шампура.
			Лимон нужно обдать кипятком и нарезать тонкими полукольцами. Чеснок так же чистим
			и режим тонкими дольками.</li>
			<li>Немного лука выкладываем на дно эмалированной кастрюли – он должен полностью 
			застелить дно. На лук выкладываете дольки лимона и чеснока, а уже поверх этого – 
			слой мяса. Дальше – слои повторяются, пока не закончатся все продукты. Сверху 
			должен быть лук.</li>
			<li>Теперь настало время для вина. Влейте его в кастрюлю, равномерно распределяя.</li>
			<li>Накрываете плотной крышкой или просто затягиваете пищевой плёнкой. 
			Оставить постоять в холодильнике примерно 6 часов.</li>
			<li>Шашлык нанизываете на шампуры, чередуя мясо с луком, лимоном </li>
			<li>Равномерно залить кусочки оставшимся вином (250 мл), сверху положить кольца лука.</li>
			<li>Жарить на умеренном огне 25-35 минут, постоянно переворачивая, до готовности.
			Во время жарки можете сбрызгивать шашлык остатками маринада.</li>
		</ol>
	</div>
	<!---------------Footer---------------->	
