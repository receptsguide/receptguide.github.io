...
<!---------------Header---------------->
					...
					<div class="container">
						...
						<div class="navbar-collapse collapse">
							<ul class="nav navbar-nav">
								<li class="active"><a href="index.php" class="smoothScroll"><span class="glyphicon glyphicon-home"></span>  Главная</a></li>
							...
							<ul class="nav navbar-nav navbar-right">
								<li><a href="#" class="smoothScroll"><span class="glyphicon glyphicon-user"></span> <?php echo $_SESSION['logged_user']->login; ?></a></li>
								<li><a href="LogOut.php" class="smoothScroll">Выйти   <span class="glyphicon glyphicon-log-out"></span></a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="l1">
				<h1><img class="img1" width="400" height="300" src="http://g1.delphi.lv/images/pix/659x380/zgB9SwedIUk/sasliks-grileta-sarkana-gala-cepsana-bbq-44634770.jpg"
				align="left" hspace="10"><ins>Главная</ins></h1>
				<div align="justify">
					<p>Как приготовить шашлык?</p>
					<p>	Над этим вопросом ежедневно задумываются миллионы людей по всему миру.
					Надеюсь, рецепты моего кулинарного сайта помогут решить Вам этот вопрос сегодня.</p>
					<img class="img2" width="500" height="380" align="right" 
					src="http://russkayakuhnya1.ru/wp-content/uploads/2016/01/shashlyk_marinad_na_kofe.jpg">
					</br></br></br></br></br></br></br></br></br></br>
					<p>	На этом сайте Вы найдете различные рецепты шашлыка, с подробными инструкциями .</p>
					<p>Это не просто место, где собраны рецепты, которые могут приготовить не только профессионалы,
					но и каждый человек на своей домашней кухне: ведь все они содержат подробные пошаговые инструкции.</p> 
					<p>Хотите узнать больше о разных ингредиентах, используемых при приготовлении блюд? К вашим услугам — наша энциклопедия.</p> 
					<p>Приготовили что-то необычное? Поспешите поделиться новым рецептом с другими читателями.</p> 	
				</div>
			</div>
<!---------------Footer---------------->	
